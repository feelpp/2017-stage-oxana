declare module fft {
    class BaseComplexArray {
        ...
        imag: any;
        length: any;
        constructor(other: any, arrayType?: Float32ArrayConstructor);
        toString(): string;
    ...
    function FFT(input: any): any;
    function InvFFT(input: any): any;
    function frequencyMap(input: any, filterer: any): any;
    class ComplexArray extends BaseComplexArray {
        FFT(): any;
        InvFFT(): any;
        frequencyMap(filterer: any): any;
    }
    function FFTImageDataRGBA(data: any, nx: any, ny: any): ComplexArray;
    function FFT2D(input: any, nx: any, ny: any, inverse?: boolean): ComplexArray;
}
declare module exports {
    function genBrownian(n?: number, r?: number, h?: number): Float32Array;
    function test_fft(): void;
}
declare module random {
    function nextGaussian(mean?: number, stdev?: number): number;
    function randomGaussians(n: number | Float32Array, mean?: number, stdev?: number): Float32Array;
}
declare module mathis {
    ...
    class Positioning {
        ...
        applyToMesh(mesh: BABYLON.Mesh): void;
...
declare module mathis {
    module grateAndGlue {
        ...
        class ConcurrentMameshesGraterAndSticker {
            ...
            SUB_PolygonCreatorFromLinks: surfaceConnection.SurfaceConnectionProcess;
            constructor();
            OUT_stickingMap: HashMap<Vertex, Vertex[]>;
            private checkArgs();
            goChanging(): Mamesh;
        }
        interface HasPosition extends HasHashString {
            position: XYZ;
        }
        class Particle implements HasPosition, HasHashString {
...
declare module mathis {
    module materials {
        ...
        class GradientColor {
            ...
            static colorToVec3(color: Array<number>): string;
            toWebGLCode(color: string, x: string): string;
        }
        class Shader {
            private static shaderId;
            protected id: string;
            scene: any;
            constructor(scene: BABYLON.Scene);
        ...
        class FuncMapperShader extends Shader {
            func: string;
...
declare module mathis {
    module periodicWorld {
        class PeriodicWorld {
            ...
            private meshRepeater;
            constructor(sizeX: number, sizeY: number, sizeZ: number, nbRepetition: number);
            posInWebCoor: XYZ;
            private currentDomain;
            centerOfCurrentDomain: XYZ;
            positionToCentredPosition(position: XYZ): XYZ;
            addMesh(abMesh: BABYLON.AbstractMesh, pullbackPositionIntoCentralDomain?: boolean): void;
            actualize(pullbackPositionIntoCentralDomain?: boolean): void;
        }
...
declare module mathis {
    class Queue {
        ...
        nextOne(): void;
        sameOne(): void;
        pushGroupOfTask(taskActions: Array<() => void>, addTimeout?: boolean): void;
        dispose(): void;
    }
}
declare module mathis {
    module reseau {
        ...
        class BasisForRegularReseau {
            nbU: number;
            set_nbV_toHaveRegularReseau: boolean;
            set_nbU_toHaveRegularReseau: boolean;
            nbV: number;
            origin: XYZ;
            end: XYZ;
        ...
        class Regular2d {
            ...
            OUT_paramToVertex: HashMap<XYZ, Vertex>;
        ...
        class Regular2dPlus {
            nbU: number;
            adaptVForRegularReseau: boolean;
            nbV: number;
            nbSubInterval_U: number;
            nbSubInterval_V: number;
            origin: XYZ;
            end: XYZ;
            nbVerticalDecays: number;
            nbHorizontalDecays: number;
            ...
            maille: Maille;
            topology: Topology;
            flatVersusNaturalShape: boolean;
            constructor();
            private inverseXY(xyz);
            go(): Mamesh;
            readonly triangle: boolean;
            private subdivisionsAndLines(mamesh, nbSubInterval_I, nbSubInterval_J);
            memorize: HashMap<Vertex, XYZ>;
            private stickingTopologies(mamesh);
        }
        class Regular1D {
            size: number;
            origin: XYZ;
...
declare module mathis {
    module surfaceConnection {
        class SurfaceConnectionProcess {
            mamesh: Mamesh;
            ...
            private normalsComputation();
            private aligningNormals(vertexToNormal);
            private alreadyFilledSurfacesDetection(vertexToNormal);
            private floatedLinksSuppression(tablinkdelete, tab_polys);
            private polygonsDetection(vertexToNormal, alreadyTravel);
            private reorderFloatingPolygon(tab_polys, tabIsFloatingLinks);
            private isInPolygon(poly, vertexIn);
            private areaAndPerimeterComputation(tab_polys);
            private fillConvexSurface(polygon, centerVertex);
            private fillNoConvexSurface(polygon, vertexToNormal);
            go(): Mamesh;
        }
    }
}
...
declare module mathis {
    module visu3d {
        ...
        class LinesViewer {
            ...
            radiusAbsolute: any;
            radiusProp: number;
            radiusFunction: (alphaRatio: number, position: XYZ) => number;
            private res;
...
declare module mathis {
    module appli {
        ...
        class Binder {
            ...
            cleanContainerBefore: boolean;
            addKeyOnTestOptions: boolean;
            rebuildCommandDico: boolean;
...
declare module mathis {
    namespace equations {
        class SurfaceEquation {
            ...
            permuteXYZ(xyzOrder: string[]): this;
        }
        class KleinBottle extends SurfaceEquation {
            rangeU: number[];
            rangeV: number[];
        ...
        class KleinBagel extends SurfaceEquation {
            rangeU: number[];
            rangeV: number[];
            r: number;
            X: (u: any, v: any) => number;
        ...
        class Cylinder extends SurfaceEquation {
            rangeU: number[];
            rangeV: number[];
            X: (u: any, v: any) => number;
            Y: (u: any, v: any) => any;
        ...
        class Moebius extends SurfaceEquation {
            rangeU: number[];
            rangeV: number[];
            X: (u: any, v: any) => number;
            Y: (u: any, v: any) => number;
        ...
        class Torus extends SurfaceEquation {
            rangeU: number[];
            rangeV: number[];
            r: number;
            a: number;
        ...
        class Boy extends SurfaceEquation {
            rangeU: number[];
            rangeV: number[];
            X: (u: any, v: any) => number;
            Y: (u: any, v: any) => number;
        ...
        class BoyAppery extends SurfaceEquation {
            rangeU: number[];
            rangeV: number[];
            a: number;
            D: (u: any, v: any) => number;
            X: (u: any, v: any) => number;
            Y: (u: any, v: any) => number;
            Z: (u: any, v: any) => number;
        }
        class CrossCappedDisk extends SurfaceEquation {
            rangeU: number[];
            rangeV: number[];
            X: (u: any, v: any) => number;
            Y: (u: any, v: any) => number;
        ...
        class SelfIntersectingDisk extends SurfaceEquation {
            rangeU: number[];
            rangeV: number[];
            X: (u: any, v: any) => number;
            Y: (u: any, v: any) => number;
        ...
        class SphericalHarmonic {
            m: any[];
            XYZ(phi: any, theta: any): XYZ;
        }
        class SurfaceEquationModified extends SurfaceEquation {
            private originalEquation;
            constructor(originalEquation: any);
            scale(lambda: number | XYZ): this;
            permuteXYZ(xyzOrder: string[]): this;
        }
    }
    module specialFunctions {
        let sinh: (x: any) => number;
        let cosh: (x: any) => number;
